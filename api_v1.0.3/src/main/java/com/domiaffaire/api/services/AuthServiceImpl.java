...
public class AuthServiceImpl implements AuthService{
    ...
    @Override
    public User createUser(SignupRequest signupRequest, byte[] imageBytes) throws WrongCodeComptableException {
        if (signupRequest.getRole().equals(UserRole.CLIENT.toString())) {
            ...
            return createdUser;
        } else if (signupRequest.getRole().equals(UserRole.COMPTABLE.toString())) {
            ...
            if ("abcd".equals(signupRequest.getCode())) {
                ...
                User createdUser = new User();
                BeanUtils.copyProperties(createdComptable, createdUser);
                return createdUser;
            } else {
                throw new WrongCodeComptableException("Code comptable does not match");
            }
        } else {
            return null;
        }
